...
<h2  style="background-color:DodgerBlue; text-align:center">Categorie Details</h2>
</div>
</table>
...
include 'connection.pdo.php';
  ...
  try
  {
     ...
     if(isset($_POST['incat']))
     {
          ...
          $cat->setId_Categ_Sup($_POST['categorie']);
...
<?php
        ...
        try
        {
         ...
         $cval = $manager -> getCategories();
        //print_r($retour);
             foreach ($cval as $valeur)  //$valeur alias $retour  
                  {   
                      echo "<div class=container>";
                      echo "<table class=table table-bordered>"; 
                      echo "<tr>";
                      echo "<td>";
                      echo "<img src='images/".$valeur['image']."' width='' height=''> ";
                      echo "</td>";
                      echo "<td>".$valeur['name']. "</td>";  
                      echo "</tr>";
                      echo "</table>" ;  
                      echo "</div>";
                  }
